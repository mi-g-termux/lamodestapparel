...
export const paypalBase = (mode) => mode === "live" ? PAYPAL_LIVE : PAYPAL_SANDBOX;
...
export const TURNSTILE_VERIFY = S + "challenges.cloudflare.com/turnstile/v0/siteverify";
...
export const withScheme = (host) => /^http/i.test(host) ? host : S + host.replace(/^\/+/, "");
